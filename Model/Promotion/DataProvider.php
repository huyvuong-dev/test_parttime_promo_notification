<?php
namespace Magenest\Promotion\Model\Promotion;
use Magenest\Promotion\Model\ResourceModel\Promotion\CollectionFactory;
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        foreach ($items as $contact) {
            ...
            $this->loadedData[$contact->getId()]['promotion'] = $contact->getData();
        }
